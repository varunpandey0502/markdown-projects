import type { PresetConfig, IssueStatusCategory, MilestoneStatusCategory } from "../types.ts";
...
export function getDefaultIssueStatus(config: PresetConfig): string {
...
export function getDefaultMilestoneStatus(config: PresetConfig): string {
